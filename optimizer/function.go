...
// Generate creates an IOptimizer instance based on the given model.Attr,
...
// Example:
//
//	attr := &model.Attr{Name: "sgd", Props: "{\"LearningRate\":0.01}"}
//	optimizer, err := Generate(attr)
func Generate(attr *model.Attr) (IOptimizer, error) {
